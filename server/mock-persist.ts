...
export type MockUser = {
  ...
  subscriptionPlan?: "trial_15" | "annual" | "staff";
  subscriptionEndsAt?: MockDate;
  trialStartedAt?: MockDate;
  trialEndsAt?: MockDate;
  subscriptionStartedAt?: MockDate;
  createdAt: MockDate;
  updatedAt: MockDate;
};
...
export type MockMeal = {
  ...
  carbs?: number; fat?: number; fiber?: number; sugar?: number; sodium?: number; cholesterol?: number;
  date: MockDate; createdAt: MockDate; updatedAt: MockDate;
};
...
export type MockDietaryPreference = {
  ...
  otherAllergies?: string; favoriteFoods?: string; proteinGoal?: number; carbGoal?: number; fatGoal?: number;
